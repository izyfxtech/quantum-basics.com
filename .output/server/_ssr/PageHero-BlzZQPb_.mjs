...
//#region node_modules/.nitro/vite/services/ssr/assets/PageHero-BlzZQPb_.js
...
function HeroBackdrop({ variant, image }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "surface-forest absolute inset-0",
			"aria-hidden": "true"
		}),
		image ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.img, {
			src: image,
			alt: "",
			"aria-hidden": "true",
			initial: {
		...
		variant === "grid" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "grid-etch absolute inset-0 opacity-30",
			"aria-hidden": "true"
		}),
		variant === "beam" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
			"aria-hidden": "true",
			initial: {
				opacity: 0,
				x: "-20%"
		...
		variant === "ledger" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			"aria-hidden": "true",
...
function PageHero({ eyebrow, title, description, children, variant = "grid", image }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		className: "relative isolate overflow-hidden text-ink-foreground",
...
//#endregion
export { PageIntro as n, SectionHeading as r, PageHero as t };
