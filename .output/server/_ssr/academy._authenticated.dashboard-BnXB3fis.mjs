...
import { A as Clock, I as Calendar, P as ChevronDown, S as LoaderCircle, _ as Megaphone, i as Users, j as CirclePlay, l as ShieldCheck, o as UserMinus, s as Trophy, w as GraduationCap, z as BookOpen } from "../_libs/lucide-react.mjs";
import { a as fetchCoursesByIds, c as fetchMyNotices, d as isCourseInstructor, f as isSuperAdmin, g as unenrol, h as staffCourseIds, l as fetchMyProgress, m as roleBadges, o as fetchMyAccess, s as fetchMyEvents, t as PortalShell, u as isAuditor } from "./roles-X33_OEsl.mjs";
import { a as fetchPlatformStats, c as removeCourseStaffMember, i as fetchCourseStaffList, r as fetchCourseRoster, s as promoteStudentToTA } from "./staff-Bnu4PpAQ.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/academy._authenticated.dashboard-BnXB3fis.js
...
function AcademyDashboard() {
	...
	const [staffCourses, setStaffCourses] = (0, import_react.useState)(null);
	const [stats, setStats] = (0, import_react.useState)(null);
	const [notices, setNotices] = (0, import_react.useState)(null);
	const [weekEvents, setWeekEvents] = (0, import_react.useState)(null);
	const load = (0, import_react.useCallback)(async () => {
		...
		const [{ data: row }, myAccess, myProgress, myNotices, myWeekEvents] = await Promise.all([
			supabase.from("profiles").select("full_name, organisation, preferred_track").eq("id", data.user.id).maybeSingle(),
			fetchMyAccess(),
			fetchMyProgress(),
			fetchMyNotices(5),
		...
		setWeekEvents(myWeekEvents);
		const staffIds = staffCourseIds(myAccess);
		if (staffIds.length) setStaffCourses(await fetchCoursesByIds(staffIds));
		else setStaffCourses([]);
		if (isSuperAdmin(myAccess) || isAuditor(myAccess)) setStats(await fetchPlatformStats());
	}, []);
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "Pick up where you left off, track lesson progress and manage your enrolments."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(GraduationCap, { className: "h-4 w-4" }), " Browse the catalogue"]
				})
			] }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				className: "mt-10 grid gap-4 lg:grid-cols-[1.3fr_1fr]",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							...
							children: "Notices"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Megaphone, { className: "h-4 w-4 text-muted-foreground" })]
					}), notices === null ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						className: "mt-3 divide-y divide-[var(--qa-line)]",
						children: notices.map((n) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								children: [
									...
									" ·",
									" ",
									new Date(n.createdAt).toLocaleDateString(void 0, {
										month: "short",
										day: "numeric"
									})
								]
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Calendar, { className: "h-3.5 w-3.5" }), " Full calendar"]
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(WeekStrip, { events: weekEvents ?? [] })]
				})]
			}),
			admin || auditor ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				className: "mt-12",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, { className: "h-3.5 w-3.5" }), " Manage roles & staffing"]
					}) : null]
					...
					className: "mt-4 text-sm text-muted-foreground",
					children: "Loading platform stats…"
				})]
			}) : null,
			staffCourses && staffCourses.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				className: "mt-12",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					className: "text-lg font-semibold tracking-tight",
					children: "Courses you teach & assist"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mt-4 space-y-4",
					children: staffCourses.map((course) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StaffCourseCard, {
						course,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					progress === null ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-6 text-sm text-muted-foreground",
						children: "Loading your courses…"
					}) : active.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mt-6 qa-card p-8 text-sm text-muted-foreground",
						children: [
						...
						children: active.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									...
									children: item.nextLesson ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
										"Next up: ",
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "text-foreground",
											children: item.nextLesson.title
										}),
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
										...
										children: item.percent === 100 ? "Review course" : "Continue"
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				className: "mt-12 qa-card p-8 md:p-10",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: WEEKDAY_LABELS.map((label, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: label }, i))
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "mt-1.5 grid grid-cols-7 gap-1",
				children: days.map((day) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: `flex h-8 items-center justify-center rounded text-xs ${day.isToday ? "bg-primary font-semibold text-primary-foreground" : "text-foreground"}`,
					children: day.dayOfMonth
				}, day.key))
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", {
				className: "mt-4 space-y-2",
				children: [days.flatMap((day) => day.events).slice(0, 4).map((event) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
					className: "text-sm",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							...
							children: [
								"·",
								" ",
								(/* @__PURE__ */ new Date(`${event.date}T00:00:00`)).toLocaleDateString(void 0, {
									weekday: "short",
									day: "numeric"
								})
							]
				...
				}, event.id)), days.every((day) => day.events.length === 0) ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
					className: "text-sm text-muted-foreground",
					children: "Nothing scheduled this week."
				}) : null]
			})
		]
	});
...
function StatCard({ icon: Icon, label, value }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "qa-card p-6",
		children: [
			Icon ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { className: "h-5 w-5 text-primary" }) : null,
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: Icon ? "mt-4 text-3xl font-semibold tracking-tight" : "text-3xl font-semibold tracking-tight",
				children: value
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
...
function StaffCourseCard({ course, canManageStaff }) {
	...
	async function handleRemoveStaff(id) {
		setBusy(true);
		await removeCourseStaffMember(id);
		setBusy(false);
		await loadDetail();
	}
	const avgPercent = roster?.length ? Math.round(roster.reduce((sum, r) => sum + r.percent, 0) / roster.length) : 0;
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Users, { className: "h-3.5 w-3.5" }), roster ? `${roster.length} enrolled · ${avgPercent}% avg. progress` : "View roster"]
				})
			...
			children: loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					...
					children: (staff ?? []).map((member) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								...
								children: ["· ", member.role === "instructor" ? "Instructor" : "Teaching assistant"]
							})
						] }), canManageStaff && member.role === "teaching_assistant" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							type: "button",
							disabled: busy,
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(UserMinus, { className: "h-3.5 w-3.5" }), " Remove"]
						}) : null]
					}, member.id))
				}),
				canManageStaff ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
							value: "",
							children: "Promote an enrolled student to TA…"
						}), eligibleForTA.map((r) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
							value: r.userId,
							children: r.fullName || r.email || r.userId
						}, r.userId))]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						type: "button",
				...
				roster && roster.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
						...
						}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: roster.map((r) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
...
//#endregion
export { AcademyDashboard as component };
