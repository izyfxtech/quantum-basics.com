...
import { D as Fuel, E as Gauge, L as Cable, O as Droplets, U as Activity, V as ArrowRight, c as Sun, d as Radio, i as Users, k as Cpu, l as ShieldCheck, t as Zap } from "../_libs/lucide-react.mjs";
import { d as StaggerItem, l as Reveal, u as Stagger } from "./router-TQIET5v8.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/services-C8Aq3O_B.js
...
function Services() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
				...
				children: services.map((service, i) => {
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
							className: "grid gap-8 border-t border-border pt-10 lg:grid-cols-[auto_1fr] lg:items-start lg:gap-12",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Stagger, {
									...
									gap: .04,
									children: service.points.map((point) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StaggerItem, {
										y: 8,
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
											className: "flex items-start gap-2.5 text-sm",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" }), point]
										})
									}, point))
								})
							] })]
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "rounded-2xl border border-border bg-secondary/70 px-8 py-14 text-center",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "Tell us what you're running and where it needs to get to — we'll scope the practice areas that apply."
					}),
