import { t as supabase } from "./client-CFL8hqg1.js";
/* empty css                 */
import { n as Route } from "./router-TQIET5v8.js";
import { n as Meter, o as Spinner, r as Panel, s as Tag, t as Btn } from "./ui-pvzeBS6D.js";
import { useCallback, useEffect, useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { ArrowLeft, Check, ChevronLeft, ChevronRight, Clock, Lock } from "lucide-react";
//#region src/routes/academy.courses.$slug.tsx?tsr-split=component
...
function CoursePage() {
	...
	const [bodies, setBodies] = useState(/* @__PURE__ */ new Map());
	...
	if (loading) return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsx(Spinner, { label: "Loading course…" })
	});
	if (!course) return /* @__PURE__ */ jsxs("div", {
		className: "qa qa-wrap py-20",
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs(Link, {
				...
				children: [/* @__PURE__ */ jsx(ArrowLeft, { className: "h-4 w-4" }), " All courses"]
			}),
			/* @__PURE__ */ jsxs("div", {
				className: "mt-5 flex flex-wrap items-start justify-between gap-4",
				children: [/* @__PURE__ */ jsxs("div", { children: [
					/* @__PURE__ */ jsx(Tag, { children: course.track }),
					/* @__PURE__ */ jsx("h1", {
			...
			enrolled ? /* @__PURE__ */ jsxs("div", {
				className: "mt-6 max-w-md",
				children: [/* @__PURE__ */ jsx(Meter, { percent: pct }), /* @__PURE__ */ jsxs("p", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("nav", {
						...
						children: previews.map((lesson, i) => {
							...
							return /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs("button", {
								...
								children: [/* @__PURE__ */ jsx("span", {
									...
									children: isDone ? /* @__PURE__ */ jsx(Check, { className: "h-3.5 w-3.5" }) : i + 1
								}), /* @__PURE__ */ jsxs("span", {
									className: "min-w-0 flex-1",
									children: [/* @__PURE__ */ jsxs("span", {
										className: "flex items-center gap-1.5 truncate font-medium",
										children: [lesson.title, !unlocked ? /* @__PURE__ */ jsx(Lock, { className: "h-3 w-3 shrink-0 text-muted-foreground" }) : null]
									}), /* @__PURE__ */ jsxs("span", {
				...
				}), /* @__PURE__ */ jsx(Panel, { children: activeLesson ? /* @__PURE__ */ jsxs(Fragment, { children: [
					/* @__PURE__ */ jsxs("p", {
					...
					unlocked && activeBody ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("div", {
						className: "qa-prose mt-4",
						children: /* @__PURE__ */ jsx("p", { children: activeBody })
					}), /* @__PURE__ */ jsx("div", {
						...
						children: [/* @__PURE__ */ jsxs("p", {
							...
							children: [/* @__PURE__ */ jsx(Lock, { className: "h-4 w-4" }), signedIn ? "Enrol in this course to unlock the full lesson." : "Sign in and enrol in this course to unlock the full lesson."]
						}), /* @__PURE__ */ jsx(Btn, {
							onClick: enrol,
							disabled: busy,
							children: signedIn ? "Enrol in this course" : "Sign in to enrol"
