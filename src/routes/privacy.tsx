...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      { title: "Privacy Policy | Quantum Basics Nigeria Limited" },
      {
        name: "description",
        content:
          "How Quantum Basics Nigeria Limited collects, uses and protects information submitted through this website and the Academy platform.",
      },
    ],
  }),
  component: Privacy,
  ...
  return (
    <section className="section-shell py-16 md:py-20">
      ...
      <p className="measure mt-4 text-base leading-relaxed text-muted-foreground">
        This policy explains how Quantum Basics Nigeria Limited collects, uses and protects
        information submitted through this website and the Academy platform. It is provided as a
        general reference and should be reviewed periodically.
      </p>
