export const academyTracks = [
  {
    ...
    scope:
      "Industrial production process automation, smart fields for oil and gas production, and security solutions.",
    modules: [
  ...
  },
  {
    ...
    scope:
      "Energy management for manufacturing and commercial buildings, and smart fuel retailing and stock management.",
    modules: [
  ...
  },
  {
    ...
    scope:
      "Commercial access network planning, installation, commissioning and optimisation, plus industrial and utility networking.",
    modules: [
